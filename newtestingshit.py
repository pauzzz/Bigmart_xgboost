...
var_mod=['Fat_Type_Combined','Outlet_Location_Type','Outlet_Size','Item_Type_Combined','Outlet_Type','Outlet']
...
data=pd.get_dummies(data,columns=['Fat_Type_Combined', 'Outlet_Location_Type', 'Outlet_Size', 'Outlet_Type', 'Item_Type_Combined', 'Outlet'])

data.dtypes


data[['Fat_Type_Combined_0','Fat_Type_Combined_1','Fat_Type_Combined_2']].head(10)
